...
import '/app/views/page/pages/about_page.dart';
import '/app/views/page/pages/clients_page.dart';
import '/app/views/page/pages/contact_page.dart';
import '/app/views/page/pages/faq_page.dart';
import '/app/views/page/pages/home_page.dart';
import '/app/views/page/pages/layout/page_layout.dart';
import '/app/views/page/pages/projects_page.dart';
import '/app/views/page/pages/services_page.dart';
